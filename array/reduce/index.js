...
// - Whatever is returned from the callback function becomes the new value
//	 of the accumulator
...
specific value is true, the value should be placed in the first subarray. If the result of the 
